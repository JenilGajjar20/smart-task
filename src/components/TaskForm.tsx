      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Task Title (Common to both modes) */}
            <div>
            ...
            {/* Description (Optional) - Removed from Basic Details and placed outside in Advanced Mode */}
            {formMode === 'advanced' && (
              <div className="pt-2">
                <label className="block text-[10px] font-bold text-[#1A1A1A] uppercase tracking-[0.15em] mb-1.5">Description (Optional)</label>
                <textarea
                  placeholder="Add notes, agenda items, or descriptions here..."
                  value={description}
            ...
            {formMode === 'quick' ? (
              /* QUICK MODE - Ultra Simple Layout */
                        ...
                        <div className="p-4 bg-white space-y-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              placeholder="e.g. Work Project, Home Improvement"
                              value={project}
                          ...
                          {/* Category-Specific Form Details */}
                          <div className="p-4 border border-[#1A1A1A] bg-[#F1EFEA]">
                            ...
                            {category === 'Health' && (
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div>
                                  <label className="block text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1 font-mono">Practice Type</label>
                                  <select
                                    value={habitType}
                            ...
                            {category === 'Shopping' && (
                              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                ...
                                <div>
                                  <label className="block text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1 font-mono">Qty</label>
                                  <input
                                    type="number"
                                    min="1"
                                ...
                                <div>
                                  <label className="block text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1 font-mono">Cost ($)</label>
                                  <input
                                    type="number"
                                    value={shoppingCost || ''}
                            ...
                            {category === 'Education' && (
                              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div>
                                  <label className="block text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1 font-mono">Subject</label>
                                  <input
                                    type="text"
                                ...
                                <div>
                                  <label className="block text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1 font-mono">Study Mins</label>
                                  <input
                                    type="number"
                                    min="5"
                                    value={studyDuration}
                                ...
                                <div>
                                  ...
                                  <input
                                    type="text"
                                    placeholder="Study materials link"
                                    value={resourceLink}
                            ...
                            {category === 'Work' && (
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div>
                                  ...
                                  <input
                                    type="text"
                                    placeholder="e.g. Blocked on designs"
                                    value={dependency}
                            ...
                            {category === 'Personal' && (
                              <p className="text-[10px] text-slate-500 italic font-serif">Focus on personal milestones. No complex fields required.</p>
                            )}
                            {category === 'Other' && (
                              <p className="text-[10px] text-slate-500 italic font-serif">Custom task block with basic parameters.</p>
                            )}
                          </div>

                          {/* Estimated Hour Effort */}
                          <div>
                      ...
                      >
                        <div className="p-4 bg-white space-y-4">
                          {subtasks.length > 0 ? (
                            ...
                            <p className="text-[11px] text-slate-400 italic">No checklist items yet.</p>
                          )}

                          <div className="flex gap-2">
                            <input
                              type="text"
                              placeholder="New subtask and press enter..."
                              value={subtaskInput}
                      ...
                      >
                        <div className="p-4 bg-white space-y-4">
                          {attachments.length > 0 ? (
                            ...
                            <p className="text-[11px] text-slate-400 italic">No attachments or links added yet.</p>
                          )}

                          {/* Add Form for Link Upload */}
                          <div className="space-y-2 border-t border-[#1A1A1A]/10 pt-2">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                              <input
                                type="text"
                                placeholder="URL Link (e.g. google.com)"
                                value={newLinkUrl}
                    ...
                    {expandedSections.status && (
                      ...
                      >
                        <div className="p-4 bg-white space-y-4">
                          ...
                          <div>
                            <label className="block text-[10px] font-bold text-[#1A1A1A] uppercase tracking-[0.15em] mb-1.5">Urgency Level</label>
                            <div className="grid grid-cols-3 gap-1 bg-[#F9F8F6] border border-[#1A1A1A] p-1 rounded-none">
                              {(['low', 'medium', 'high'] as Priority[]).map((p) => {
                                const isSelected = priority === p;
                                const activeColors = {
                                  low: 'bg-[#1A1A1A] text-white',
                          ...
                          <div>
                            <label className="block text-[10px] font-bold text-[#1A1A1A] uppercase tracking-[0.15em] mb-1.5 font-sans">
                              Task Status
                            </label>
                            <select
                              value={status}
                  ...
                  <AnimatePresence initial={false}>
                    {expandedSections.privateNotes && (
                      ...
                      >
                        <div className="p-4 bg-white space-y-4">
                          <div>
                            <label className="block text-[10px] font-bold text-[#1A1A1A] uppercase tracking-[0.15em] mb-1.5 font-sans">Private Notes / Links</label>
                            <input
                              type="text"
                              placeholder="Access keys, private codes, extra URLs..."
                              value={notes}
                              onChange={(e) => setNotes(e.target.value)}
                              className="w-full px-4 py-2.5 bg-[#F9F8F6] border border-[#1A1A1A] rounded-none outline-none focus:ring-1 focus:ring-[#C2410C] text-[#1A1A1A] text-sm font-serif"
                            />
                          </div>
                        </div>
                      </motion.div>
                    ...
                    {expandedSections.schedule && (
                      ...
                      >
                        <div className="p-4 bg-white space-y-4">
                          ...
                          {/* Reminder Setup */}
                          <div className="bg-[#F9F8F6] p-3 border border-[#1A1A1A]/10 space-y-3">
                          ...
                          {/* Recurrence Setup */}
                          <div className="bg-[#F9F8F6] p-3 border border-[#1A1A1A]/10 space-y-3">
                            <span className="block text-[10px] font-bold text-[#1A1A1A] uppercase tracking-wider font-sans">Repeat Settings</span>
                            <div>
                              <select
                              ...
                              <div className="grid grid-cols-2 gap-3 pt-1">
                                <div>
                                  ...
                                  <input
                                    ...
                                    className="w-full px-3 py-2 bg-white border border-[#1A1A1A] rounded-none outline-none text-[#1A1A1A] text-xs font-serif"
                                  />
                                </div>
                                <div>
                                  ...
                                  <select
                                    ...
                                    className="w-full px-3 py-2 bg-white border border-[#1A1A1A] rounded-none outline-none text-[#1A1A1A] text-xs font-serif cursor-pointer"
                                  >
